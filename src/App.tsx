...
const caseStudies = [
  ...
  },
  {
    ...
    strategy: 'Integrated ManyChat, HubSpot, and other tools to build a self-optimizing lead ecosystem.',
...
const tools = [
  ...
  'HubSpot', 'WordPress', 'Canva', 'Adobe Suite' , 'Notion', 'Google Analytics' 
];
    ...
    >
      <div className="flex-1">
        ...
        <p className="text-zinc-500 leading-relaxed mb-6 max-w-lg">
          My portfolio showcases web design projects, brand video productions, product photoshoots,
          graphic design posters, and marketing materials — all built to demonstrate the full range
          of creative and performance work.
        </p>
        <div className="flex flex-wrap gap-2">
          {['Web Design', 'Brand Video', 'Product Photoshoot', 'Poster Design', 'Marketing Materials', 'Meta Ad Creatives'].map(tag => (
      ...
      <a
        ...
        className="group flex items-center gap-2 px-8 py-4 bg-zinc-900 text-white rounded-full font-semibold hover:bg-zinc-800 transition-all whitespace-nowrap flex-shrink-0"
      >
